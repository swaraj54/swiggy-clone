            ...
            <div className="PastOrdersSingleCard">
              <div className="PastOrdersSingleCard1">
                ...
                <div className="PastOrdersSingleCardDetails">
                  <div className="PastOrdersSingleCardDetails1">{el.from_add.name}</div>
                  <div className="PastOrdersSingleCardDetails2">{el.from_add.address}</div>
                    ...
                    <div className="editProfileDrawer">
                      ...
                      <div className="pastOrdersViewDetails">
                        <div className="pastOrdersViewDetails1">
                          ...
                          <div>
                            <div className="pastOrdersViewDetails12">{el.from_add.name}</div>
                            <div className="pastOrdersViewDetails13">{el.from_add.address}</div>
                          </div>
                        </div>
                        <div className="pastOrdersViewDetails1a">
                          ...
                          <div>
                            <div className="pastOrdersViewDetails12">{el.to_add.name}</div>
                            <div className="pastOrdersViewDetails13">{el.to_add.address}</div>
                          </div>
                        </div>
                        ...
                        <div className="pastOrdersViewDetails4">
                          <div className="pastOrdersViewDetails41">{el.items.length} ITEMS</div>
                            ...
                            {el.items.map((el1) => {
                              return (
                                <div style={{ display: "flex" }}>
                                  ...
                                  <div className="pastOrdersViewDetails422">₹ {el1.price}</div>
                                </div>
                              );
                            })}
                          </div>
                        ...
                        <div className="pastOrdersViewDetails5">
                          <div className="pastOrdersViewDetails51">
                            <div style={{ margin: "2px 40px" }}>₹ {el.total_paid}</div>
                            <div>Total Bill</div>
                          </div>
                        </div>
                      </div>
              ...
              >
                <h2 style={{ padding: "10px", textAlign: "center" }}>
                  Please seat back.. <br /> Our custmer care will contact you on registered mobile
                  number
                </h2>
              </Dialog>
